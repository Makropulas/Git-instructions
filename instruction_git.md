...
+ ## *Перемещение ветки на определённый коммит*

Для перемещения ветки на определённый коммит, используется так называемый "branch forcing":

    git branch -f <имя ветки> HEAD>~<количество>
    
    например: git branch -f main HEAD~3
